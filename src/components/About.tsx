...
const About: React.FC = () => {
  return (
    <section className="about">
      ...
      <p>I´m studying frontend development, a 2 year long Higher Vocational Education program that teaches the basics of frontend development and web design. 
        The big part of the second year is spent as an intern at a company, where I get to learn and apply my skills in a real-world environment.
